...
# Сборка проекта
Сборка проекта: make generate - генерирует ендпоинты, моки и собирает проект
Запуск тестов: make test - запускает юнит и интеграционные тесты
Запуск линтера: make lint - линтер. Описан в .golangci.yaml

Также существует возможность запустить все раазом: make all
